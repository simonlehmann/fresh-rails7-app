...
# - vim: text editor for Rails Credentials editing
# - git: support git commands triggers by rails generators (rails new, upgrade, etc.)
RUN apk --update add build-base nodejs tzdata postgresql-dev postgresql-client libxslt-dev libxml2-dev vim git
